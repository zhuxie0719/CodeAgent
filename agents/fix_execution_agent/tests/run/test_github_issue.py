...
def test_configure_if_first_time_called():
    ...
    with (
        patch("fixcodeagent.run.github_issue.configure_if_first_time") as mock_configure,
        patch("fixcodeagent.run.github_issue.fetch_github_issue") as mock_fetch,
        patch("fixcodeagent.run.github_issue.InteractiveAgent") as mock_agent,
        patch("fixcodeagent.run.github_issue.get_model"),
        patch("fixcodeagent.run.github_issue.DockerEnvironment"),
        patch("fixcodeagent.run.github_issue.yaml.safe_load") as mock_yaml_load,
        patch("fixcodeagent.run.github_issue.get_config_path") as mock_get_config_path,
        patch("fixcodeagent.run.github_issue.save_traj"),
    ):
...
def test_github_issue_end_to_end(github_test_data):
    ...
    with (
        patch("fixcodeagent.run.github_issue.configure_if_first_time"),
        patch("fixcodeagent.run.github_issue.get_model") as mock_get_model,
