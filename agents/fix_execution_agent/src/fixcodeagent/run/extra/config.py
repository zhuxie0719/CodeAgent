...
You can edit it manually or use the [bold green]fix-code-extra config set[/bold green] or [bold green]fix-code-extra config edit[/bold green] commands.
...
def setup():
    ...
    console.print(
        "\n[bold yellow]Config finished.[/bold yellow] If you want to revisit it, run [bold green]fix-code-extra config setup[/bold green]."
    )
