...
def read_file():
    ...
    if not file_path.startswith(os.path.normpath('uploads' + os.sep)):
...
def process_data():
    ...
    except (pickle.UnpicklingError, EOFError, AttributeError, ImportError, IndexError, TypeError, ValueError, base64.binascii.Error) as e:
